...
public class DepositInventory {
    public static ItemStack[] getContents() {
        ...
        contents[0] = createGuiItem(Material.LIGHT_GRAY_STAINED_GLASS_PANE, "DEPOSIT", "This is a secret c;");
        ...
        contents[10] = createGuiItem(Material.YELLOW_WOOL, "§aAdd §l+100");
        contents[19] = createGuiItem(Material.YELLOW_STAINED_GLASS, "§aAdd §l+10");
        contents[28] = createGuiItem(Material.GOLD_INGOT, "§aAdd §l+1");

        contents[16] = createGuiItem(Material.GRAY_WOOL, "§cRemove §l-100");
        contents[25] = createGuiItem(Material.GRAY_STAINED_GLASS, "§cRemove §l-10");
        contents[34] = createGuiItem(Material.IRON_INGOT, "§cRemove §l-1");

        contents[22] = createGuiItem(Material.GOLD_ORE, "§4ERROR, please report.");
    ...
    public static void updateInventory(Player player, Integer playerData) {
        ...
        meta.setDisplayName("§eYou're depositing: " + amount);
