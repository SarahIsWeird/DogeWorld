...
import com.sarahisweird.dogeworld.tasks.RemoveTownSetupNextTick;
...
public class TownManager {
     ...
     */
    public static void onInput(Player player, String message, DogeWorld dogeWorld) {
        for (Iterator<TownSetup> iterator = townsInSetup.iterator(); iterator.hasNext(); ) {
            ...
            if (townSetup.player == player) {
                ...
                if (townSetup.isDone()) {
                    (new RemoveTownSetupNextTick(townsInSetup, townSetup)).runTaskLater(dogeWorld, 1L);
                }
